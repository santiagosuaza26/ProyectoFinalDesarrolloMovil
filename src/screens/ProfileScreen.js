...
export function ProfileScreen() {
    ...
    return (<Screen>
      <View style={styles.photoRow}>
        ...
        <AppButton onPress={handlePickPhoto} title={photoUrl ? t('changPhoto') : t('selectPhoto')} variant="secondary" style={styles.photoButton} loading={uploadingPhoto}/>
      </View>
      <AppTextInput label={t('fullName')} maxLength={50} onChangeText={setFullName} value={fullName}/>
      <Text style={styles.helper}>{fullName.length}/50</Text>
      <AppTextInput keyboardType="number-pad" label={t('phoneNumber')} onChangeText={setPhoneNumber} value={phoneNumber}/>
      <GenderPicker value={gender} onChange={setGender}/>
      <AppTextInput autoCapitalize="none" keyboardType="email-address" label={t('email')} onChangeText={setEmail} value={email}/>
